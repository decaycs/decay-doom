;;; doom-dark-decay-theme.el --- inspired by the Dark-decay theme -*- lexical-binding: t; no-byte-compile: t; -*-
;; Author: Alxhr0
...
(defgroup doom-dark-decay-theme nil
  "Options for the `doom-dark-decay' theme."
  :group 'doom-themes)

(defcustom doom-dark-decay-brighter-modeline nil
  "If non-nil, more vivid colors will be used to style the mode-line."
  :group 'doom-dark-decay-theme
  :type 'boolean)

(defcustom doom-dark-decay-brighter-comments nil
  "If non-nil, comments will be highlighted in more vivid colors."
  :group 'doom-dark-decay-theme
  :type 'boolean)

(defcustom doom-dark-decay-colorful-headers nil
  "If non-nil, headers in org-mode will be more colorful; which is truer to the
original Dracula Emacs theme."
  :group 'doom-dark-decay-theme
  :type 'boolean)

(defcustom doom-dark-decay-comment-bg doom-dark-decay-brighter-comments
  "If non-nil, comments will have a subtle, darker background. Enhancing their
legibility."
  :group 'doom-dark-decay-theme
  :type 'boolean)

(defcustom doom-dark-decay-padded-modeline doom-themes-padded-modeline
...
(def-doom-theme doom-dark-decay
  "A dark theme based on the Dark-decay theme"

  ;; name        default   256       16
  ((bg         '("#101419" "#262626" "black"        ))
   (bg-alt     '("#14181f" "#1c1c1c" "black"        ))
   (base0      '("#171c24" "#1c1c1c" "black"        ))
   (base1      '("#1a2029" "#1e1e1e" "brightblack"  ))
   (base2      '("#1f2630" "#2e2e2e" "brightblack"  ))
   (base3      '("#28303d" "#262626" "brightblack"  ))
   (base4      '("#2f3847" "#3f3f3f" "brightblack"  ))
   (base5      '("#6272a4" "#525252" "brightblack"  ))
   (base6      '("#b6b6b2" "#bbbbbb" "brightblack"  ))
   (base7      '("#ccccc7" "#cccccc" "brightblack"  ))
   (base8      '("#f8f8f2" "#dfdfdf" "white"        ))
   (fg         '("#b6beca" "#ffffff" "white"        ))
   (fg-alt     '("#aab1bd" "#bfbfbf" "brightwhite"  ))

   (grey       base4)
   (red        '("#e05f65" "#fc7b81" "red"          ))
   (orange     '("#ffb86c" "#ffbb66" "brightred"    ))
   (green      '("#78dba9" "#94f7c5" "green"        ))
   (teal       '("#0189cc" "#0088cc" "brightgreen"  ))
   (yellow     '("#f1cf8a" "#ffeba6" "yellow"       ))
   (blue       '("#70a5eb" "#8cc1ff" "brightblue"   ))
   (dark-blue  '("#0189cc" "#0088cc" "blue"         ))
   (magenta    '("#c68aee" "#e2a6ff" "magenta"      ))
   (violet     '("#bd93f9" "#bb99ff" "brightmagenta"))
   (cyan       '("#74bee9" "#90daff" "brightcyan"   ))
   ...
   (selection      dark-blue)
   (builtin        blue)
   (comments       (if doom-dark-decay-brighter-comments dark-cyan base5))
   (doc-comments   (doom-lighten (if doom-dark-decay-brighter-comments dark-cyan base5) 0.25))
   (constants      cyan)
   (functions      blue)
   (keywords       magenta)
   (methods        teal)
   ...
   (level1 blue)
   (level2 red)
   (level3 (if doom-dark-decay-colorful-headers green   (doom-lighten violet 0.35)))
   (level4 (if doom-dark-decay-colorful-headers yellow  (doom-lighten magenta 0.35)))
   (level5 (if doom-dark-decay-colorful-headers cyan    (doom-lighten violet 0.6)))
   (level6 (if doom-dark-decay-colorful-headers orange  (doom-lighten magenta 0.6)))
   (level7 (if doom-dark-decay-colorful-headers blue    (doom-lighten violet 0.85)))
   (level8 (if doom-dark-decay-colorful-headers magenta (doom-lighten magenta 0.85)))
   (level9 (if doom-dark-decay-colorful-headers violet  (doom-lighten violet 0.95)))

   (-modeline-bright doom-dark-decay-brighter-modeline)
   (-modeline-pad
    (when doom-dark-decay-padded-modeline
      (if (integerp doom-dark-decay-padded-modeline) doom-dark-decay-padded-modeline 4)))
  ...
  (((line-number &override) :foreground base5)
   ...
   ((font-lock-comment-face &override)
    :background (if doom-dark-decay-comment-bg (doom-lighten bg 0.05) 'unspecified))
   (mode-line
...
;;; doom-dark-decay-theme.el ends here
